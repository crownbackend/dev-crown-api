...
{
    /**
     * @Groups({"videos", "lastVideos", "video", "technology", "playlists", "playlist", "search"})
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @Groups({"videos", "playlists", "playlist"})
    ...
    /**
     * @Groups({"playlists", "playlist", "videos", "lastVideos", "technology", "video", "search"})
     * @ORM\Column(type="string", length=255)
     */
    private $slug;
